...
@Service
public class ReadXMLFileDomService
{
  private static final Logger logger = LoggerFactory.getLogger(ReadXMLFileDomService.class);
  
  public List<Cotacao> read(String content)
