package br.cs.execao;

public class InvestimentoBusinessException
  extends Exception
{
  ...
  public InvestimentoBusinessException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
  {
