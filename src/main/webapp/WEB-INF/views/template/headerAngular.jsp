...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="/Investimentos/site/index">Gestão de Investimentos</a>
	</div>
	<!-- /.navbar-header -->
	<ul class="nav navbar-top-links navbar-right">
		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-envelope fa-fw"></i><span id="qtdNaoLido" title="Feeds não lidos"></span> <i
		...
		<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <i
			...
			<ul class="dropdown-menu dropdown-user">
				<li><a href="#" onclick="linkIn('config/carregarPagina');"><i class="fa fa-user fa-fw"></i> Usuário</a></li>
			...
			<ul class="nav" id="side-menu">
				...
				<li><a href="#"><i class="fa fa-edit fa-fw"></i> Investimento<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						...
						<li><a href="/Investimentos/site/operacaoView" id="linkAjaxGet_head_4">Renda Variável</a></li>
					</ul> <!-- /.nav-second-level --></li>
				<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Gráficos<span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li><a href="#">Renda Fixa</a></li>
						<li><a href="/Investimentos/site/graficos/telaChartS" id="linkAjaxGet_head_5">Renda Variável</a></li>
